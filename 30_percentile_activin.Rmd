...
```{r message= FALSE, warning= FALSE, echo = FALSE}
dir <- "~/Desktop/quants"
samples <- read.csv(file= "~/Desktop/meta_30_tumor_activin.csv")
...
```{r echo = FALSE}
library(DESeq2)
sample_meta_data <- read.csv(file= "~/Desktop/meta_30_tumor_activin.csv")
```
...
```{r message= FALSE, warning= FALSE, echo = FALSE}
dir <- "~/Desktop/quants"
samples <- read.csv(file= "~/Desktop/meta_30_ascites_activin.csv")
files <- file.path(dir, samples$Sample, "quant.sf")
all(file.exists(files))
txi <- tximport(files, type = "salmon", tx2gene= tx2gene, ignoreAfterBar= TRUE)
names(txi)
...
```{r echo = FALSE}
library(DESeq2)
sample_meta_data <- read.csv(file= "~/Desktop/meta_30_ascites_activin.csv")
```
